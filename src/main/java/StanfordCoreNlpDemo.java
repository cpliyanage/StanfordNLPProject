  ...
  public static void main(String[] args) throws IOException {
    ...
    if (args.length > 0) {
      ...
      //annotation = new Annotation("Kosgi Santosh sent an email to Stanford University. He didn't get a reply.");
    	annotation = new Annotation("There is a blue table. There is a brown box on it. There is a red chair left to the table.");
    ...
    System.out.println("Printing reselts of the pipeline");
